...
List<QuizResponse> quizResponseFromJson(String str) => List<QuizResponse>.from(json.decode(str).map((x) => QuizResponse.fromJson(x)));

String quizResponseToJson(List<QuizResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class QuizResponse {
    ...
    String? instructions;
    QuizResponseMetadata? metadata;
    String? questionId;
    ResponseData? data;
    QuizResponseSolution? solution;
    String? attachment;
    ...
    factory QuizResponse.fromJson(Map<String, dynamic> json) => QuizResponse(
        ...
        metadata: QuizResponseMetadata.fromJson(json["metadata"]),
        questionId: json["questionID"],
        data: ResponseData.fromJson(json["data"]),
        solution: QuizResponseSolution.fromJson(json["solution"]),
...
class QuizResponseMetadata {
    QuizResponseMetadata({
    ...
    factory QuizResponseMetadata.fromJson(Map<String, dynamic> json) => QuizResponseMetadata(
...
class QuizResponseSolution {
    QuizResponseSolution({
        this.data,
        this.answer,
        this.stepNav,
        this.type,
    ...
    factory QuizResponseSolution.fromJson(Map<String, dynamic> json) => QuizResponseSolution(

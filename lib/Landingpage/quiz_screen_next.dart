...
class QuizScreenNext extends StatefulWidget {
  const QuizScreenNext({Key? key}) : super(key: key);

  @override
  State<QuizScreenNext> createState() => _QuizScreenNextState();
}

class _QuizScreenNextState extends State<QuizScreenNext>
                          ...
                          InkWell(
                            onTap: isDisable == true
                                ...
                                : () {
                                  ...
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const QuizScreenTwo(),
                                  ),
                                ); */
                                      Navigator.pushReplacement(
                                          context,
